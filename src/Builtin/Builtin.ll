...
; Function Attrs: nofree nounwind uwtable
define dso_local noalias ptr @string_substring(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = sub i32 %2, %1
  %5 = add nsw i32 %4, 1
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @string_parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
define dso_local i32 @string_ord(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #4 {
...
define dso_local ptr @string_add(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
...
; Function Attrs: argmemonly mustprogress nofree nounwind readonly willreturn uwtable
define dso_local zeroext i1 @string_leq(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #8 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #13
  %4 = icmp slt i32 %3, 1
  ret i1 %4
}
...
; Function Attrs: argmemonly mustprogress nofree nounwind readonly willreturn uwtable
define dso_local zeroext i1 @string_geq(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #8 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #13
  %4 = icmp sgt i32 %3, -1
  ret i1 %4
}
...
; Function Attrs: argmemonly mustprogress nofree nounwind readonly willreturn uwtable
define dso_local zeroext i1 @string_neq(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #8 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #13
  %4 = icmp ne i32 %3, 0
  ret i1 %4
}
